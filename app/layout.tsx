          ...
          <nav className="bg-gray-100 border-b p-4">
            <div className="max-w-6xl mx-auto flex justify-between items-center">
              <ul className="flex space-x-6">
                ...
                <SignedIn>
                  <li>
                    <Link href="/trades" className="text-blue-600 hover:text-blue-800 font-medium">
                      Trades
                    </Link>
                  </li>
                  <li>
                    <Link href="/account" className="text-blue-600 hover:text-blue-800 font-medium">
                      My Account
                    </Link>
                  </li>
                  <li>
              ...
              <div className="flex items-center space-x-4">
                <SignedOut>
                  ...
                  <Link href="/sign-up" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">
                    Sign Up
                  </Link>
                </SignedOut>
                <SignedIn>
